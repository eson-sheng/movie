!function (e, t) {
    ...
    return function (e) {
                ...
                key: "initScreenshotButton", value: function () {
                    ...
                    this.player.options.screenshot && this.player.template.camareButton.addEventListener("click", function () {
                        ...
                        t.toBlob(function (e) {
                            ...
                            t.href = n, t.download = json.name, t.style.display = "none", document.body.appendChild(t), t.click(), document.body.removeChild(t), URL.revokeObjectURL(n)
            ...
            return o(e, [{
                ...
                key: "send", value: function (e, t) {
                    ...
                    this.options.apiBackend.send({
                        ...
                        success: function(){
                            t();
                            let xhr = new XMLHttpRequest(), ret;
                            xhr.open(
                                "GET",
                                "./index.php?s=token",
                                true
        ...
        t.default = function (e) {
            ...
            }, {text: "About author", link: "http://shengxuecheng.cn/"}, {
                text: "Eson二次开发",
                link: "https://github.com/eson-sheng/movie"
            }]), e
        }
    }, function (e, t, n) {
        "use strict";
        ...
        console.log("\n %c Eson二次开发 %c http://shengxuecheng.cn/ \n\n", "color: pink; background: #030307; padding:5px 0;", "background: pink; padding:5px 0;"), t.default = o.default
    }]).default
});
